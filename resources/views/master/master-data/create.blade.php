...
@section('title', 'Tambah Master Data - Sistem Panen Sawit')
@section('page-title', 'Tambah Master Data')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Tambah Master Data</h2>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Masukkan data master kebun, divisi, SPH, luas TM, dan budget</p>
                </div>
        ...
        <form action="{{ route('master.master-data.store') }}" method="POST" class="p-6">
            @csrf
...
$(document).ready(function() {
    // Format budget input
    $('#budget_alokasi').on('input', function() {
        let value = $(this).val();
        if (value) {
